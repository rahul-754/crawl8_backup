...
- General Physician = General Practice = General Practitioner = GP = Physician = Family Medicine = General Medicine = Internal Medicine
...
- Extract fellowships, certificates, memberships, or specialized training.
- Allowed formats:
• Fellowship (e.g., Fellowship in Intensive Care Medicine)
• Certificate (e.g., Certificate Course in Anaesthesia Critical Care)
• Memberships (e.g., Member of National Academy of Medical Sciences)
